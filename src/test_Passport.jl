...
@test Passport.reader("\\testdata\\passport_2valid.txt")==2
...
@test Passport.reader("\\testdata\\passport_4valids.txt")==4
@test Passport.reader("\\testdata\\passport_0valids.txt")==0
